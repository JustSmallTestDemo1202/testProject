...
namespace AISystem.States
{
    ...
    public class Wander : Simple
    {
        ...
        {
            Vector3 random = new Vector3(initialPosition.x + UnityEngine.Random.Range(-range, range), initialPosition.y, initialPosition.z + UnityEngine.Random.Range(-range, range));
            if (raycast)
            {
                RaycastHit hit;
